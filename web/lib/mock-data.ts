...
export const TRAINERS: Trainer[] = [
  ...
  },
  {
    ...
    graveyard: [
      { species: "Roserade", sprite: sprite("roserade"), types: ["Grass", "Poison"], ability: "Natural Cure", moves: ["Leaf Storm", "Sludge Bomb", "Toxic Spikes", "Sleep Powder"], hp: 0, maxHp: 237, level: 50, fainted: true },
    ],
  },
  {
    name: "Jazz",
...
export const BATTLES: Battle[] = [
  ...
  },
  {
    ...
    p2Casualties: ["Whimsicott", "Amoonguss"],
